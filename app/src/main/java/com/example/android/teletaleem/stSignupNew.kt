...
import com.example.android.teletaleem.databinding.ActivityStSignupNewBinding
import com.example.android.teletaleem.databinding.ActivityStudentBinding
import java.util.regex.Pattern


class stSignupNew : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        var binding:ActivityStSignupNewBinding= ActivityStSignupNewBinding.inflate(layoutInflater)
        ...
        binding.btn.setOnClickListener() {
            ...
            if (name.length > 5 && CNIC.trim().length == 13 && mobilenumber.trim().length == 10 && mygender != "" && isValidEmailAddress(
                ...
                startActivity(Intent(this,stDetailsNew::class.java))
            }
